...
public class GemStonesTitleScreen extends TitleScreen {

    private static final ResourceLocation SPLASH =
            new ResourceLocation(GemStones.MOD_ID, "textures/gui/background/title.png");
    ...
    private void drawMinecraftLogo(@NotNull PoseStack poseStack) {
        ...
        drawString(poseStack, this.getMinecraft().font, "Gemstones Mod by Mxscha",
                this.width / 2 - (this.font.width("Gemstones Mod by Mxscha") / 2) - 60, 76, 0xFFFFFFFF);
    }
