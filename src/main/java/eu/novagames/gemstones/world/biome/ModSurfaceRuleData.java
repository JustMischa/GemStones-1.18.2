...
public class ModSurfaceRuleData
{
    ...
    private static final SurfaceRules.RuleSource STONE = makeStateRule(Blocks.GRASS_BLOCK);
    ...
    private static final SurfaceRules.RuleSource TEST = makeStateRule(ModBlocks.RAW_CAERULA_BLOCK.get());
    ...
    public static SurfaceRules.RuleSource makeRules()
    {
        ...
        return SurfaceRules.sequence(
                ...
                // SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR, TEST)
        );
    }
