...
public class TenebrisTrunkPlacer extends TrunkPlacer {

    public static final Codec<TenebrisTrunkPlacer> CODEC = RecordCodecBuilder.create((p_70161_) -> {
        return trunkPlacerParts(p_70161_).apply(p_70161_, TenebrisTrunkPlacer::new);
    });

    public TenebrisTrunkPlacer(int p_70148_, int p_70149_, int p_70150_) {
